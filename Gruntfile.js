module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify:{
            dist:{
                src:['<banner:meta.banner>', 'dist/todo.combined.js'],
        ...
        cssmin:{
            compress:{
                files:{
                    'dist/todo.min.css':['<banner:meta.banner>', 'dist/todo.css']
                }
            }
        },
        transform_html:{
        ...
        copy:{
            cordova:{
                files: [
                    ...
                    { dest: 'cordova/www/css/', cwd: 'dist', expand: true, src: 'todo.min.css'},
                    { dest: 'cordova/www/js/', cwd: 'dist', expand: true, src: 'todo.min.js'},
